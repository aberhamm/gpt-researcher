...
class GPTResearcher:
    ...
    async def conduct_research(self):
        ...
        # Hybrid search including both local documents and web sources
            ...
            self.context = await self.__get_context_by_vectorstore(
                self.query, self.vector_store_filter
            )
    ...
    async def __process_sub_query_with_vectorstore(
        ...
        content = await self.__get_similar_content_by_query_with_vectorstore(
            sub_query, filter
        )
